...
public class AppDownloadService extends Service {
    ...
    public static final String VEHICLESCA_APK = "VehicleScanning.apk";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final Request apkdown = new Request.Builder().url(qppurl).build();
        client.newCall(apkdown).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response)  {
                try {
                    ...
                    File dir = new File(Environment.getExternalStorageDirectory()+"/VehicleScanning/");
                    if(!dir.exists()){
                        dir.mkdir();
                    }
