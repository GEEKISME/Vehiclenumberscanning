package com.biotag.vehiclenumberscanning.NFC;
...
//    public static final String URL_GETSTAFFPHOTO            = MAINHOST            +    "api/photo/getstaffphoto/{staffid}";
     ...
     */
    public static final String APP_VERSION                  =   MAINHOST    +    "api/Version/Get/mobile";
    public static final String APP_FILE                     =   MAINHOST    +    "/setup/VehicleScanning.apk";
